...
(setq elpaca-installer-version 0.12)
(let ((elpaca-path (expand-file-name "elpaca/sources/elpaca" user-emacs-directory)))
...
(elpaca (elpaca :repo "https://github.com/progfolio/elpaca.git" :build (:not elpaca-activate)))
(elpaca leaf
  (require 'leaf)
